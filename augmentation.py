...
class DropEdgeAndFeature(object):
    def __init__(self, drop_weight,d_fea=0.2, d_edge=0.3):
    ...
    def _drop_edge(self, g):
        ...
        edge_index_1 = drop_edge_weighted(g.edge_index, self.drop_weight, p=self.drop_edge_ratio, threshold=0.7)
        return edge_index_1